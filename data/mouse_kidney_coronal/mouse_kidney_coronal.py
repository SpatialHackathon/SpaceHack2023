...
samples_info = [{
                ...
                "filtered_matrix": "https://cf.10xgenomics.com/samples/spatial-exp/1.1.0/V1_Mouse_Kidney/V1_Mouse_Kidney_filtered_feature_bc_matrix.h5",
                "spatial": "https://cf.10xgenomics.com/samples/spatial-exp/1.1.0/V1_Mouse_Kidney/V1_Mouse_Kidney_spatial.tar.gz",
               }]
...
with tempfile.TemporaryDirectory() as temp_dir: 
    for i, sample_info in enumerate(samples_info):
        ...
        samples_df.loc[i] = [i, sample_id, np.nan, np.nan, np.nan, sample_id]
