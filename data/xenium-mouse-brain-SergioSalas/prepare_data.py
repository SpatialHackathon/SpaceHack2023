...
def convert_data(out_dir):
    ...
    gdown.download_folder(url=file_download_link, output=str(temp_dir), quiet=False)
    print('...done')
    ...
    project_root = out_dir / "xenium-brain-SergioSalas"
    ...
    with open(project_root / 'data.json', 'w') as f:
