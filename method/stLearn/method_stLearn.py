        ...
        try:
            ...
            if technology != 'Visium':
                ...
                if image_json is not None:
                    ...
                    scale = scale_factors.get('scale', 1.0)
                    spot_diameter_fullres = scale_factors.get('spot_dimeter_fullres', 50.0)
                else:
                    scale = 1.0
...
if config["method"] == "kmeans":
    ...
    st.tl.clustering.louvain(adata, resolution=config["resolution"], key_added="cluster", random_state=seed)
