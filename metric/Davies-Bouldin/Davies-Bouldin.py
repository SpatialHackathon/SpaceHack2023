...
# Author_and_contribution: Kirti Biharie; implemented Davis-Bouldin score

import argparse

parser = argparse.ArgumentParser(description="Calculate Davies-Bouldin Score (scikit-learn)")
...
if args.embedding is None:
    raise Exception("Embeddings needed to calculate the Davies-Bouldin Score")
...
metric = sklearn.metrics.davies_bouldin_score(embeddings, labels)
