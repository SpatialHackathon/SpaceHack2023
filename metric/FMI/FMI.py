...
# Author_and_contribution: Kirti Biharie; implemented fmi score

import argparse

parser = argparse.ArgumentParser(description="Calculate Fowlkes-Mallows index (scikit-learn)")
...
if args.ground_truth is None:
    raise Exception("Groundtruth labels needed to calculate the Fowlkes-Mallows index")
...
metric = sklearn.metrics.fowlkes_mallows_score(ground_truth, labels)
