...
parser.add_argument(
    "-r", "--radius", default=None,help="Compute the graph based on neighborhood radius", required=False
)

parser.add_argument(
    "--delaunay", type=bool,default=False,help="Whether to compute the graph from Delaunay triangulation.", required=False
)
...
sq.gr.spatial_neighbors(adata, coord_type=coord_type, n_neighs=n_neighs, radius=radius, delaunay=delaunay, n_rings=n_rings)
